...
@section('header')
<a class="nav-item mr-sm-2" href="{{ route('bookindex') }}">
...
<a class="nav-item mr-sm-2" href="{{ route('codeindex') }}">
    <button type="button" class="btn btn-outline-primary">
        <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-code-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<a class="nav-item mr-sm-2" href="{{ route('accountindex') }}">
    <button type="button" class="btn btn-outline-primary">
